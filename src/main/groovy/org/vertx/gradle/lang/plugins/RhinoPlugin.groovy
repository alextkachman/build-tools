...
import org.vertx.gradle.lang.tasks.JSdoc
 ...
 *
 */
class RhinoPlugin extends AbstractSourcePlugin {

	public static final String CONFIGURATION = 'vertxRhino'

	public static final String SOURCE_DIR = 'javascript'

	public static final String SOURCE_EXTENSION = 'js'
...
/*		project.tasks.withType(JSdoc, new Action<JSdoc>() {
			void execute(JSdoc jsdoc) {
			}
		})
*/		
		JSdoc jsdoc = project.tasks.add(DOCUMENTATION_TASK, JSdoc)
		Task build = project.tasks.findByName('build')
		build.dependsOn jsdoc
		Task javadoc = project.tasks.findByName('javadoc')
		javadoc.dependsOn jsdoc
	}
